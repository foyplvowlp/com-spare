...
/**
 * This is the model class for table "report_etc".
 *
 * The followings are the available columns in table 'report_etc':
 * @property integer $id
 ...
 */
class ReportEtc extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('type, howto', 'length', 'max'=>45),
	 ...
	 * @return ReportEtc the static model class
	 */
