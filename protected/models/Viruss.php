...
/**
 * This is the model class for table "viruss".
 *
 * The followings are the available columns in table 'viruss':
 * @property integer $id
 ...
 */
class Viruss extends CActiveRecord
{
	/**
	 ...
	 * @return Viruss the static model class
	 */
