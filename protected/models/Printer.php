...
class Printer extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('date, department_id, type, ink, total, howto, finish', 'required'),
            array('department_id, total', 'numerical', 'integerOnly' => true),
            array('type', 'length', 'max' => 46),
            array('ink', 'length', 'max' => 24),
            array('howto', 'length', 'max' => 200),
            array('finish', 'length', 'max' => 33),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, date, department_id, type, ink, total, howto, finish', 'safe', 'on' => 'search'),
        );
    }
